...
public enum AuthErrorStatus implements ErrorReason {
    ...
    INVALID_ACCESS_TOKEN(HttpStatus.BAD_REQUEST,"AUTH_4003", "유효하지 않은 리프레시토큰입니다."),
    ...
    INVALID_PROVIDER(HttpStatus.BAD_REQUEST,"AUTH_4004","유효하지 않은 소셜 로그인 타입입니다."),
    INVALID_OAUTH_TOKEN(HttpStatus.BAD_REQUEST,"AUTH_4005","유효하지 않은 소셜 로그인 토큰입니다.");
