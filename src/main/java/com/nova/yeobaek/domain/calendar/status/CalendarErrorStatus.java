...
public enum CalendarErrorStatus implements ErrorReason {
	...
	//  월 기능 추가 (400)
	INVALID_YEAR_MONTH(HttpStatus.BAD_REQUEST, "COMMON400", "yearMonth 형식이 올바르지 않습니다. (yyyy-MM)"),
	MONTH_IMAGE_ONLY_RECENT_3MONTHS(HttpStatus.BAD_REQUEST, "COMMON400", "월 이미지 저장은 최근 3개월 이내만 가능합니다."),
	...
	//  월 이미지 조회용 (404)
	CALENDAR4044(HttpStatus.NOT_FOUND, "CALENDAR4044", "해당 월의 월 이미지가 존재하지 않습니다."),
